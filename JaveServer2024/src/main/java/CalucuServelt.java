...
/**
 * Servlet implementation class CalucuServelt
 */
@WebServlet("/CalucuServelt")
public class CalucuServelt extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CalucuServelt() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    if(result < 200 ) {
	    	...
	    	out.append("<html><body><h2>계산기 서블릿 결제화면</h2><hr>");
